  ...
  function createBoard() {
    ...
    for (let i = 0; i < squares.length; i++) {
      ...
      if (squares[i].classList.contains('valid')) {
        if (i > 1 && !isLeftEdge && squares[i -1].classList.contains('bomb')) total ++
        if (i > 5 && !isRightEdge && squares[i +1 -width].classList.contains('bomb')) total ++
        if (i > 6 && squares[i -width].classList.contains('bomb')) total ++
        if (i > 7 && !isLeftEdge && squares[i -1 -width].classList.contains('bomb')) total ++
        if (i < 24 && !isRightEdge && squares[i +1].classList.contains('bomb')) total ++
